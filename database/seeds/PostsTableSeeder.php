    ...
    public function run()
    {
        $posts = [
            [
                ...
                "author_img"=> 'images/posts/fw90AuDIuzw4dT5U44y20pU0fDILayHhReer811H.png',"Drops Luffy",
                "source_url"=>"http://127.0.0.1/public/admin",
                "active"=>"1",
            ],
            [
                "category_id"=> '1',
            ...
            [
                "category_id"=>"2",
                "title"=>"To an English person, it will seem like simplified English,",
                "img"=>"images/LcpxPHguhVl440rpJWtn5YHJvACLxT6v8pvmjTa9.jpeg",
                "description"=>" Europe uses the same vocabulary. The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes",
            ...
            [
                "category_id"=>"3",
                "title"=>"Europe uses the same vocabulary.",
                "img"=>"images/LcpxPHguhVl440rpJWtn5YHJvACLxT6v8pvmjTa9.jpeg",
                "description"=>" Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators. To",
